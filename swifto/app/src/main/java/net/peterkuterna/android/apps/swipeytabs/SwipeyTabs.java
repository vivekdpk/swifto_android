...
public class SwipeyTabs extends ViewGroup implements OnPageChangeListener {
	...
	// <item name="android:background">#39C0F3</item>
	//<color name="walk_map_bg_top">#163363</color>
	//private int mBottomBarColor = 0xff39C0F3;   0xff949494
	...
	private ISwipeyTabsPageChangeNotifiable mPageChangeNotifiable;
	public void setSwipeyTabsPageChangedNotifiable(ISwipeyTabsPageChangeNotifiable notifiable)
	{
		mPageChangeNotifiable = notifiable;
	}
	...
	public void onPageSelected(int position) {
		...
		if(mPageChangeNotifiable != null)
		{
			mPageChangeNotifiable.onPageChanged(position);
		}
	}
