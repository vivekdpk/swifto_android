...
public class QuickAction extends PopupWindows implements OnDismissListener {
	 ...
	 */
	public void addActionItem(ActionItem action, String imageUrl) {
		...
		*/
		...
		new AQuery(container).id(R.id.iv_icon).image(imageUrl, true, true, 0, R.drawable.dog_default_big).height(50, true).width(50, true);
